...
namespace RageMP_Gangwar.Models
{
    class ServerAccounts
    {
        ...
        public static void CreateAccount(Client player, string username)
        {
            try
            {
        ...
        public static string GetAdminPrefix(int adminLevel)
        {
            try
            {
                switch(adminLevel)
                {
                    ...
                    case 4: return "(!{#15ff00}Test-Supporter~w~)"; //Test Supporter
                    case 5: return "(!{#02780e}Supporter~w~)"; //Supporter
                    case 6: return "(!{#0532fa}Moderator~w~)"; //Moderator
                    ...
                    case 11: return "(!{#e00000}Projektleitung~w~)"; //Projektleitung
                }
            }
            catch (Exception e)
            {
        ...
        public static string GetChatRankColor(int aLevel)
        {
            try
            {
                switch(aLevel)
                {
                    ...
                    case 4: return "!{#15ff00}";
                    case 5: return "!{#02780e}";
                    case 6: return "!{#0532fa}";
                    case 7: return "!{#f0e007}";
                    case 8: return "!{#ff7700}";
                    case 9: return "!{#e00000}";
                    case 10: return "!{#ff00dd}";
                    case 11: return "!{#e00000}";
                }
            }
            catch (Exception e)
            {
